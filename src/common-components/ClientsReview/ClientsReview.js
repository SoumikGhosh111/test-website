    ...
    return (
        <div className='clients-review-section-wrapper'>
            ...
            <div className="wrapper-clients-review">
                <i id="right-clients-review" className="fa-solid fa-angle-right d-none"><WestRoundedIcon  sx={{fontSize: "13px"}}/></i>
                ...
                <i id="left-clients-review" className="fa-solid fa-angle-left d-none"><EastRoundedIcon sx={{fontSize: "13px"}}/></i>
