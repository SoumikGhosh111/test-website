    ...
    return (
        <div className='our-values-comp-wrapper'>
            ...
            <div className='our-values-content our-values-container-items'>
                ...
                <span className='sub-span'> At Powermycode Solutions Private Limited, our values aren't just words; they're the driving force behind every line of code, every design pixel, and every client interaction.</span> <br/> <br/> 
