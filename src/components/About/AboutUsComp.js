    ...
    return (
        <div className='about-us-comp-wrapper' id='about_us'>
            ...
            <div className='about-us-content about-us-container-items'>
                <p>At PowerMyCode Pvt Ltd Solution, We empower success through tailored strategic solutions. From innovative consulting to business development and monitoring, we navigate the complexities of the business landscape with you.</p>
